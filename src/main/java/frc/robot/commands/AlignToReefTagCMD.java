...
public class AlignToReefTagCMD extends Command {
    ...
    public void execute() {
        ...
        SmartDashboard.putNumber("botPose_FwBw", LimelightHelpers.getBotPose3d_TargetSpace(limelightName).getX());
        SmartDashboard.putNumber("botPose_LR", LimelightHelpers.getBotPose3d_TargetSpace(limelightName).getY());
